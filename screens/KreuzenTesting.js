...
const KreuzenTesting = ({ navigation }) => {
    return (
        <View style={styles.container} >
            ...
            <View style={styles.footer} >
                <Image source={require('../assets/kreuzentesting.png')} style={styles.img_style} ></Image>
                <Text style={styles.para_text} >Schneiden Sie die Wassermelonen eine Minute lang so oft wie möglich</Text>
                <TouchableOpacity style={styles.btn_submit} onPress={() => { navigation.navigate('KreuzenBigExercise') }} >
