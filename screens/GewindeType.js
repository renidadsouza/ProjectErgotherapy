...
const GewindeType = ({ navigation }) => {
    return (
        <View style={styles.container} >
            <View style={styles.header} >
                <Text style={styles.header_text} >Übung 8</Text>
            </View>
            <View style={styles.footer} >
                <Text style={styles.footer_text} >Drehen Sie die Muttern komplett ab und wieder drauf von groß nach klein</Text>
