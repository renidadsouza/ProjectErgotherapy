...
const ZielenType = ({ navigation }) => {
    return (
        <View style={styles.container} >
            <View style={styles.header} >
                <Text style={styles.header_text} >Übung 1</Text>
            </View>
            <View style={styles.footer} >
                ...
                <TouchableOpacity style={styles.btn_submit} onPress={() => { navigation.navigate('ZielenTesting') }} >
