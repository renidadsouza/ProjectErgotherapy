...
const KlötzeType = ({ navigation }) => {
    return (
        <View style={styles.container} >
            <View style={styles.header} >
                <Text style={styles.header_text} >Übung 7</Text>
            </View>
            <View style={styles.footer} >
                <Text style={styles.footer_text} >Stellen Sie einen Klotz auf und legen Sie den zweiten quer oben drauf </Text>
